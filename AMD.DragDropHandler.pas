...
type
	...
	//
	/// /////////////////////////////////////////////////////////////////////////////
	TDragDropHandler=class(TDropContextMenu,IShellExtInit,IContextMenu,IContextMenu2,IContextMenu3)
	private
	protected
...
function TDragDropHandler.Initialize(pidlFolder:PItemIDList;lpdobj:IDataObject;hKeyProgID:HKEY):HResult;
begin
	if (pidlFolder<>nil) then Result:=inherited Initialize(pidlFolder,lpdobj,hKeyProgID)
