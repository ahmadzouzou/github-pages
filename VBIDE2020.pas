...
type
  ...
  WindowDisp=dispinterface
    ...
    property HWND_:Integer readonly dispid 120;
  end;
  ...
  _Windows=interface(_Windows_old)
    ...
    function CreateToolWindow(const AddInInst:AddIn;const ProgId:WideString;
      const Caption:WideString;const GuidPosition:WideString;var DocObj:IDispatch):Window;safecall;
  end;
  ...
  _WindowsDisp=dispinterface
    ['{F57B7ED0-D8AB-11D1-85DF-00C04F98F42C}']
    function CreateToolWindow(const AddInInst:AddIn;const ProgId:WideString;
      const Caption:WideString;const GuidPosition:WideString;var DocObj:IDispatch):Window;
      dispid 300;
    property VBE:VBE readonly dispid 1;
    property Parent:Application readonly dispid 2;
    function Item(index:OleVariant):Window;dispid 0;
  ...
  Events=interface(IDispatch)
    ...
    property CommandBarEvents[const CommandBarControl:IDispatch]:CommandBarEvents
      read Get_CommandBarEvents;
  end;
  ...
  EventsDisp=dispinterface
    ...
    property CommandBarEvents[const CommandBarControl:IDispatch]
      :CommandBarEvents readonly dispid 205;
  end;
  ...
  Property_=interface(IDispatch)
    ...
    property IndexedValue[Index1:OleVariant;Index2:OleVariant;Index3:OleVariant;Index4:OleVariant]
      :OleVariant read Get_IndexedValue write Set_IndexedValue;
  ...
  _CodeModule=interface(IDispatch)
    ...
    function CreateEventProc(const EventName:WideString;const ObjectName:WideString)
      :Integer;safecall;
    function Find(const Target:WideString;var StartLine:Integer;var StartColumn:Integer;
      var EndLine:Integer;var EndColumn:Integer;WholeWord:WordBool;MatchCase:WordBool;
      PatternSearch:WordBool):WordBool;safecall;
    ...
    property ProcStartLine[const ProcName:WideString;ProcKind:vbext_ProcKind]:Integer
      read Get_ProcStartLine;
    property ProcCountLines[const ProcName:WideString;ProcKind:vbext_ProcKind]:Integer
      read Get_ProcCountLines;
    property ProcBodyLine[const ProcName:WideString;ProcKind:vbext_ProcKind]:Integer
      read Get_ProcBodyLine;
  ...
  _CodeModuleDisp=dispinterface
    ...
    property ProcStartLine[const ProcName:WideString;ProcKind:vbext_ProcKind]
      :Integer readonly dispid 1610743819;
    property ProcCountLines[const ProcName:WideString;ProcKind:vbext_ProcKind]
      :Integer readonly dispid 1610743820;
    property ProcBodyLine[const ProcName:WideString;ProcKind:vbext_ProcKind]
      :Integer readonly dispid 1610743821;
    property ProcOfLine[Line:Integer;out ProcKind:vbext_ProcKind]
      :WideString readonly dispid 1610743822;
    ...
    function Find(const Target:WideString;var StartLine:Integer;var StartColumn:Integer;
      var EndLine:Integer;var EndColumn:Integer;WholeWord:WordBool;MatchCase:WordBool;
      PatternSearch:WordBool):WordBool;dispid 1610743825;
  ...
  _CodePaneDisp=dispinterface
    ...
    procedure SetSelection(StartLine:Integer;StartColumn:Integer;EndLine:Integer;EndColumn:Integer);
      dispid 1610743812;
