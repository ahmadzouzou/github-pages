...
{ TCategoryButtonsl }
  ...
  TButtonDrawState = set of TButtonDrawStateItem;
  ...
  TCatButtonOptions = set of TCatButtonOption;
...
{ TButtonCategory }
  ...
  public
    ...
    property Bounds: TRect read GetBounds;
		property Data: TCustomData read FData write FData;
		property EXTS: string read FEXT write FEXT;
  published
    property Caption;
    property CategoryButtons: TCategoryButtons read GetCategoryButtons;
